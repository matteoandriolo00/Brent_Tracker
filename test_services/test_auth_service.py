...
def test_register_user_raises_when_email_already_exists(service: AuthService) -> None:
    ...
    with pytest.raises(ValueError, match="Email già registrata"):
        service.register_user(email="Exists@Example.com", password="secret123")
...
def test_authenticate_user_returns_user_for_valid_credentials(service: AuthService) -> None:
    ...
    authenticated_user = service.authenticate_user("Test@Example.com", "secret123")
...
def test_authenticate_user_returns_none_for_invalid_password(service: AuthService) -> None:
    ...
    authenticated_user = service.authenticate_user("test@example.com", "wrong-password")
